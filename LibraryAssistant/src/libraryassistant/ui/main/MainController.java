...
public class MainController implements Initializable {
    ...
    private void loadAddMember(ActionEvent event) {
        loadWindow("/libraryassistant/ui/addmember/member_add.fxml", "Add New Member");
    }

    @FXML
    private void loadAddBook(ActionEvent event) {
        loadWindow("/libraryassistant/ui/addBook/add_book.fxml", "Add New Book");
    }

    @FXML
    private void loadMemberTable(ActionEvent event) {
        loadWindow("/libraryassistant/ui/listmember/member_list.fxml", "Member List");
    }

    @FXML
    private void loadBookTable(ActionEvent event) {
        loadWindow("/libraryassistant/ui/listbook/book_list.fxml", "Book List");
    }
    ...
    private void loadIssueOperation(ActionEvent event) {
        ...
        if(response.get()==ButtonType.OK){
            ...
            if(databaseHandler.execAction(str)&&databaseHandler.execAction(str2)){
                ...
                alert1.setHeaderText(null);
                alert1.setContentText("Issue Operation Fail");
                alert1.showAndWait();
            }
        }else{
                Alert alert1 = new Alert(Alert.AlertType.INFORMATION);
    ...
    private void loadBookInfo2(ActionEvent event) {
        ...
        try {
            while(rs.next()){
                ...
                while(r1.next()){
                    issuedData.add("Book Name: " + r1.getString("title"));
                    issuedData.add("Book ID: " + r1.getString("id"));
                    issuedData.add("Book Author: " + r1.getString("author"));
                    issuedData.add("Book Publisher: " + r1.getString("publisher"));
                }
                ...
                while(r1.next()){
                    issuedData.add("Name : " + r1.getString("name"));
                    issuedData.add("Mobile : " + r1.getString("mobile"));
                    issuedData.add("Email : " + r1.getString("email"));
                }
        ...
        issueDataList.getItems().setAll(issuedData);
    }
    ...
    private void loadRenewOp(ActionEvent event) {
        ...
        if(response.get()==ButtonType.OK){
            ...
            if(databaseHandler.execAction(ac)){
                ...
                alert1.setTitle("Cancelled");
                alert1.setHeaderText(null);
                alert1.setContentText("Renewal Operation Cancelled");
                alert1.showAndWait();
        }
